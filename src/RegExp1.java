...
public class RegExp1 {
	...
	public static void main(String[] args) {
		...
		// Demander et recuperer la chaine de caracteres recherchee (expression
		// reguliere)
		...
		// EXERCISE 1 : TROUVER TOUT LES OCCURENCES DU String RECHERCHEE DANS LE String
		// POUR LA RECHERCHE

		/*
		 * 
		 * //Nous utilisons la methode .find() pour matcher while(matcher.find()) {
		 * System.out.println("Le(s) mots \""+matcher.group()+"\" debute a l'indice "
		 * +matcher.start() + " et finit a l'indice " + matcher.end()); }
		 * 
		 */
		...
		/*
		 * 
		 * if(matcher.matches()) { System.out.println("Les deux textes sont les memes");
		...
		if (matcher.lookingAt()) {
			System.out.println("On a trouve \"" + matcher.group() + "\" commencant a l'indice " + matcher.start()
