...
public class Ajouter extends Application {
	...
	public void start(Stage primaryStage) {
		...
		// Mettre à jour l'équation dans lbl pour refléter la somme des deux valeurs
		// dans txt1 et txt2 apres une modification a txt1
		txt1.textProperty().addListener((observable, oldValue, newValue) -> {
			System.out.println(txt1.getText());
			lbl.setText((txt1.getText().isEmpty() ? "0" : lbl.getText()) + " + "
					+ (txt2.getText().isEmpty() ? "0" : lbl.getText()) + " = "
					+ (Integer.parseInt((txt1.getText().isEmpty() ? "0" : lbl.getText()))
							+ Integer.parseInt((txt2.getText().isEmpty() ? "0" : lbl.getText()))));
		});

		// Mettre à jour l'équation dans lbl pour refléter la somme des deux valeurs
		// dans txt1 et txt2 apres une modification a txt2
		txt2.textProperty().addListener((observable, oldValue, newValue) -> {
			System.out.println(txt1.getText());
			lbl.setText((txt1.getText().isEmpty() ? "0" : lbl.getText()) + " + "
					+ (txt2.getText().isEmpty() ? "0" : lbl.getText()) + " = "
		...
		// Ajouter tous les elements (les deux TextField et le Label) au groupe
		// d'elements
